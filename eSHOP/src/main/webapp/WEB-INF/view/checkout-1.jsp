	...
	<div class="container main-container headerOffset">
		...
		<div class="row">
			<div class="col-lg-9 col-md-9 col-sm-12">
				...
				<!--FORM  -->
				<form:form action="checkout-4" method="post" modelAttribute="wrapUserAddress">
					<div class="col-xs-12 col-sm-12">
						<div class="w100 clearfix" style="height: 12%;">
							<ul class="orderStep orderStepLook2">
								<li class="active"><a href="checkout-1"> <i
										class="fa fa-map-marker "></i> <span> address</span>
								</a>
								</li>
								
								<!-- <li><a href="checkout-2"> <i
										class="fa fa fa-envelope  "></i> <span> Billing </span></a></li>
								<li><a href="checkout-3"><i class="fa fa-truck "> </i><span>Shipping</span>
								</a></li>
								 -->
								<li><a href="checkout-4"><i class="fa fa-money  ">
									</i><span>Payment</span> </a></li>
								<li><a href="checkout-5"><i class="fa fa-check-square ">
						...
						<div class="w100 clearfix">
							<div class="row userInfo">
								...
								<div class="col-lg-12">
									<h2 class="block-title-2">To add a new address, please
									...
									<div class="col-xs-12 col-sm-6">
										...
										<div class="form-group required">
											<form:label path="addresstitle">Address Title. <sup>*</sup>
											</form:label>

											<form:input required="required" type="text"
												name="addresstitle" class="form-control" id="addresstitle"
												path="addresstitle"></form:input>
										...
										<div class="form-group required">
											...
											<form:input required="required" type="text"
												class="form-control" id="addressLine1" path="addressLine1"></form:input>
										</div>
										...
										<div class="form-group">
											<form:label path="additionalinfo">Additional information / Landmark</form:label>
									...
									<div class="col-xs-12 col-sm-6">
										...
										<div class="form-group required">
											...
											<form:select required="required" name="country" id="country"
						...
						<div class="cartFooter w100">
							<div class="box-footer">
								<div class="pull-left">
									<a class="btn btn-default" href="index"> <i
										class="fa fa-arrow-left"></i> &nbsp; Back to Shop
									</a>
								</div>
								<div class="pull-right">
									<button class="btn btn-primary btn-small ">
										Shipping address &nbsp; <i class="fa fa-arrow-circle-right"></i>
									</button>
								</div>
							</div>
						</div>
