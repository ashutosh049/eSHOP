			...
			<div class="row">
				<div class="col-lg-9 col-md-9 col-sm-7">
					...
					<div class="row userInfo">
						<div class="col-lg-12">
							<h2 class="block-title-2">Product Categories List</h2>
							<button class="table-add btn btn-primary pull-right"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Add Category</button>
							<span class="pull-right">&nbsp;&nbsp;&nbsp;</span>
							<button id="refeshTabs" class=" btn btn-default pull-right"><i class="fa fa-refresh" aria-hidden="true"></i> Update</button>
						</div>
					...
					<div id="table" class="table-editable">
						...
						<table class="table" id="tabTable">
							...
							<c:forEach items="${wrapTabList}" var="tab">
								<tr class="updatableRow" wrapTabId="${tab.wrapTabId}">
									<td contenteditable="false" class="editableField" fieldName="wrapTabId">${tab.wrapTabId}</td>
									<td contenteditable="true" class="editableField" fieldName="wrapTabName">${tab.wrapTabName}</td>
									<td contenteditable="true" class="editableField" fieldName="wrapTabSortOrder">${tab.wrapTabSortOrder}</td>
									<td>
							...
							<tr class="hide insertableRow" style="color:#66de97;">
								<td contenteditable="true">Enter Category Id...</td>
					...
					<div class="row userInfo">
						<div class="col-lg-12">
							<button id="udateTabs" class="btn btn-primary pull-left"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
							<br>
							<hr>
						</div>
					</div>
