<footer>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3  col-md-3 col-sm-4 col-xs-6">
					...
					<ul>
						<li class="supportLi">
							<p>For any queries and help please contact at</p>
							<h4>
								<a class="inline" href="callto:+16602386717"> <strong>
										<i class="fa fa-phone"> </i> +1 660-238-6717
								</strong>
								</a>
							</h4>
							<h4>
	...
	<div class="footer-bottom">
		<div class="container">
			<p class="pull-left">&copy; eSHOP 2016. All right reserved.</p>
