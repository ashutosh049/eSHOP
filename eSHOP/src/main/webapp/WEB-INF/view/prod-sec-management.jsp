		...
		<div class="row">
			...
			<div class="container">
			    <ol class="breadcrumb breadcrumb-arrow">
					...
					<li class="active"><span>${wrapTabId}</span></li>
				</ol>
			</div>
			...
			<div class="col-lg-9 col-md-9 col-sm-7">
				...
				<div class="row userInfo">
					<div class="col-lg-12">
						<div class="col-lg-6 pull-left">
							<h2 class="">Product Section List</h2>
						</div>
						<div class="col-lg-6 pull-right">
							<a data-toggle="modal" data-target="#addColModal" class="btn btn-default btn-link btn-md">
	                            Add New Section(Col) <i class="fa fa-plus"></i> </a>
						</div>
					</div>
				...
				<div class="modal  fade" id="addColModal" tabindex="-1" role="dialog">
				    <div class="modal-dialog" style="width: 65%;">
				        <div class="modal-content">
				            <div class="modal-header">
				                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times; </button>
				                <h3 class="modal-title-site text-center">Add New Column </h3>
				            </div>
				            <div class="modal-body">
				              <div class="table-responsive">
										<form action="createWrapCol" method="post" role="form">
											<div class=" col-lg-4">
											...
											<div class=" col-lg-4">
												...
												<input id="wrapColId" type="text" name="wrapColId" class="wrap-ids-class"></input>
											</div>
											<div class=" col-lg-4">
												<label for="wrapColName">Col Name</label> <br>
												<input id="wrapColName" type="text" name="wrapColName" ></input>
											</div>
											<div class=" col-lg-4">
												<label for="wrapColSortOrder">Sort Order *</label> <br>
												<input type="text" id="wrapColSortOrder" name="wrapColSortOrder" class="sort-order-class"></input>
											</div>
											<div class="col-md-12">
				...
				<div class="paymentBox">
					<div class="panel-group paymentMethod" id="accordion">
						<c:forEach items="${wrapColumnList}" var="column">
							<div class="panel panel-default">
								<div class="panel-heading panel-heading-custom">
									<h4 class="panel-title">
										<a class="cashOnDelivery" data-toggle="collapse"
											data-parent="#accordion"
											href="#${column.wrapTabId}${column.wrapColId}"> <span
											class="fa-fw"><strong> ${column.wrapTabId} <i
													class="fa fa-chevron-right fa-fw" aria-hidden="true"></i>
											</strong></span> <span class="fa-fw"><strong>
													${column.wrapColId} <i class="fa fa-chevron-right fa-fw"
													aria-hidden="true"></i>
											</strong></span> <span class="fa-fw"><strong>
													${column.wrapColName} </strong></span>
										</a>
									</h4>
								</div>
								<div id="${column.wrapTabId}${column.wrapColId}"
									...
									<div class="panel-body">
										...
										<div class="panel open">
											<div class="creditCard col-lg-12">
												<form action="updateWrapColForm" method="post" role="form">
													<div class="paymentInput col-lg-6">
														...
														<input path1="ccNumber" id="wrapTabId" type="text"
															value="${column.wrapTabId}" name="wrapTabId"
													...
													<div class="paymentInput col-lg-6">
														...
														<input path1="ccNumber" id="wrapColId" type="text"
															value="${column.wrapColId}" name="wrapColId"
															style="width: 100%;" maxlength="16"></input>
													</div>
													<div class="paymentInput col-lg-6">
														<label path1="ccNumber" for="wrapColName">Col Name
															Id</label> <br> <input path1="ccNumber" id="wrapColName"
															type="text" value="${column.wrapColName}"
															name="wrapColName" style="width: 100%;" maxlength="16"></input>
													</div>
													<div class="paymentInput col-lg-6">
														<label for="wrapColSortOrder" path1="ccCvvNumber">Sort
															Order *</label> <br> <input type="text"
															id="VerificationCode" value="${column.wrapColSortOrder}"
															path1="wrapColSortOrder" name="wrapColSortOrder"
													...
													<div class="col-md-12">
														<div class="col-md-4">
															<button class="btn btn-primary btn-small"
																id="updateWrapColSbmtBtn">
																Update &nbsp; <i class="fa fa-arrow-circle-right"></i>
															</button>
														</div>
														<div class="col-md-4">
															<a class="btn btn-danger btn-small " 
																href="deleteCol?wrapTabId=${column.wrapTabId}&wrapColId=${column.wrapColId}">
																Delete &nbsp; <i class="fa fa-trash-o" aria-hidden="true"></i>
															</a>
														</div>
														<div class="col-md-4">
															<a class="btn btn-default btn-small " 
																href="viewProductCarton?wrapTabId=${column.wrapTabId}&wrapColId=${column.wrapColId}">
																View Cartons(Cat) &nbsp; <i class="fa fa-arrow-circle-right"></i>
															</a>
														</div>
													</div>
