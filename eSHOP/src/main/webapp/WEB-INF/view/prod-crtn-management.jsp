		...
		<div class="row">
			...
			<div class="container">
			    <ol class="breadcrumb breadcrumb-arrow">
					<!-- <li><a href="admin-panel">Admin Home</a></li> -->
					...
					<li class="active"><span>${wrapColId}</span></li>
				</ol>
			</div>
			...
			<div class="col-lg-9 col-md-9 col-sm-7">
				<div class="row userInfo">
					<div class="col-lg-12">
						<div class="col-lg-6 pull-let">
							<h2 class="">Product Carton List</h2>
						</div>
						<div class="col-lg-6 pull-right">
							<a data-toggle="modal" data-target="#addCatModal" class="btn btn-default btn-link btn-md">
	                            Add New Carton(Cat) <i class="fa fa-plus"></i> </a>
						</div>
					</div>
				        ...
				        <div class="modal-content">
				            ...
				            <div class="modal-body">
				              <div class="table-responsive">
										<form action="createWrapCat" method="post" role="form">
											<div class=" col-lg-4">
												<label for="wrapTabId">Tab Id</label> <br>
												<input id="wrapTabId" type="text" name="wrapTabId" value="${wrapTabId}" class="wrap-ids-class wrap-disabled"></input>
											</div>
											<div class=" col-lg-4">
												<label for="wrapColId">Col Id</label> <br>
												<input id="wrapColId" type="text" name="wrapColId" value="${wrapColId}" class="wrap-ids-class wrap-disabled"></input>
											</div>
											<div class=" col-lg-4">
												<label for="wrapCatId">Cat Id</label> <br>
												<input id="wrapCatId" type="text" name="wrapCatId" class="wrap-ids-class"></input>
											</div>
											<div class=" col-lg-4">
												<label for="wrapCatName">Cat Name</label> <br>
												<input id="wrapCatName" type="text" name="wrapCatName" ></input>
											</div>
											<div class=" col-lg-4">
												<label for="wrapCatSortOrder">Sort Order *</label> <br>
												<input type="text" id="wrapCatSortOrder" name="wrapCatSortOrder" class="sort-order-class"></input>
											</div>
											<div class="col-md-12">
				...
				<div class="paymentBox">
					<div class="panel-group paymentMethod" id="accordion">
						<c:forEach items="${wrapCategoryList}" var="category">
							<div class="panel panel-default">
								<div class="panel-heading panel-heading-custom">
									<h4 class="panel-title">
										<a class="cashOnDelivery" data-toggle="collapse"
											data-parent="#accordion"
											href="#${category.wrapTabId}${category.wrapColId}${category.wrapCatId}"> 
											<span
											class="fa-fw"><strong> ${category.wrapTabId} <i
													class="fa fa-chevron-right fa-fw" aria-hidden="true"></i>
											</strong></span>
											 <span class="fa-fw"><strong>
													${category.wrapColId} <i class="fa fa-chevron-right fa-fw"
													aria-hidden="true"></i>
											</strong></span> 
											<span class="fa-fw"><strong>
													${category.wrapCatId} </strong></span>
											<span class="fa-fw"><strong>
													${category.wrapCatName} </strong></span>
										</a>
									</h4>
								</div>
								<div id="${category.wrapTabId}${category.wrapColId}${category.wrapCatId}"
									...
									<div class="panel-body">
										...
										<div class="panel open">
											<div class="creditCard col-lg-12">
												<form action="updateWrapCat" method="post" role="form">
													<div class="paymentInput col-lg-6">
														<label path1="ccNumber" for="wrapTabId">Tab Id</label> <br>
														<input path1="ccNumber" id="wrapTabId" type="text"
															value="${category.wrapTabId}" name="wrapTabId"
															style="width: 100%;" maxlength="16"></input>
													</div>
													<div class="paymentInput col-lg-6">
														<label path1="ccNumber" for="wrapColId">Col Id</label> <br>
														<input path1="ccNumber" id="wrapColId" type="text"
															value="${category.wrapColId}" name="wrapColId"
															style="width: 100%;" maxlength="16"></input>
													</div>
													<div class="paymentInput col-lg-6">
														<label path1="ccNumber" for="wrapCatId">Cat Id
															Id</label> <br> <input path1="ccNumber" id="wrapCatId"
															type="text" value="${category.wrapCatId}"
															name="wrapCatId" style="width: 100%;" maxlength="16"></input>
													</div>
													<div class="paymentInput col-lg-6">
														<label path1="wrapCatName" for="wrapCatName">Cat Name
															Id</label> <br> <input path1="wrapCatName" id="wrapCatName"
															type="text" value="${category.wrapCatName}"
															name="wrapCatName" style="width: 100%;" maxlength="16"></input>
													</div>
													<div class="paymentInput col-lg-6">
														<label for="wrapCatSortOrder" path1="wrapCatSortOrder">Sort
															Order *</label> <br> <input type="text"
															id="wrapCatSortOrder" value="${category.wrapCatSortOrder}"
															path1="wrapCatSortOrder" name="wrapCatSortOrder"
													...
													<div class="col-md-12">
														...
														<div class="col-md-4">
															<a class="btn btn-danger btn-small " 
																href="deleteWrapCat?wrapTabId=${category.wrapTabId}&wrapColId=${category.wrapColId}&wrapCatId=${category.wrapCatId}">
																Delete &nbsp; <i class="fa fa-trash-o" aria-hidden="true"></i>
															</a>
														</div>
														<div class="col-md-4">
															<a class="btn btn-default btn-small " 
																href="viewProductCrtnItem?wrapTabId=${category.wrapTabId}&wrapColId=${category.wrapColId}&wrapCatId=${category.wrapCatId}">
																View Items &nbsp; <i class="fa fa-arrow-circle-right"></i>
															</a>
														</div>
													</div>
												</form>
