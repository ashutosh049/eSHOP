                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix" style="height: 12%;">
                        <ul class="orderStep orderStepLook2">
                            ...
                            <li class="active"><a href="checkout-2"> <i class="fa fa fa-envelope  "></i> <span> Billing </span></a>
                            </li>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            ...
                            <div class="pull-left">
                                <a class="btn btn-default" href="checkout-1"> <i class="fa fa-arrow-left"></i>
                                    &nbsp; Shipping address </a></div>
                            <div class="pull-right">
                                <a href="checkout-3" class="btn btn-primary btn-small "> Shipping method &nbsp; <i
