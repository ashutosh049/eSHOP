 ...
 * @version $Revision$
 */
public class MultipartWrapProduct extends WrapProduct{
	...
	private MultipartFile wrapProdImage;
	private int wrapProdSortOrder;

	public MultipartWrapProduct() {
	...
	/**
	 * @return the wrapProdImage
	 */
	public MultipartFile getWrapProdImage() {
		return wrapProdImage;
	}

	/**
	 * @param wrapProdImage the wrapProdImage to set
	 */
	public void setWrapProdImage(MultipartFile wrapProdImage) {
		this.wrapProdImage = wrapProdImage;
	}
